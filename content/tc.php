...
<nav id="navbar-example2" class="navbar navbar-expand-lg fixed-top" style="background-color: #eeeeff;">
  ...
  ">
    ...
    <div class="collapse navbar-collapse text-white" id="navbarSupportedContent" style="z-index:1000">
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item ">
          <a class="nav-link  d-flex align-items-center active-nav" href="tc.php"><ion-icon name="newspaper"></ion-icon>&nbsp;terms and conditions</a>
        </li>
         <li class="nav-item ">
  ...
  <center> <h2 style="color: goldenrod;" class="mb-3">Terms & Conditions</h2></center>
