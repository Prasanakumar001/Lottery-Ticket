...
<script type="text/javascript">
       ...
       document.getElementByclassName('card').style.backgroundColor = random_color;
       $('#card').css('backgroundColor', random_color);
  </script>
    ...
    <div class="collapse navbar-collapse text-white" id="navbarSupportedContent" style="z-index:1000">
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link  d-flex align-items-center active-nav"  href="about.php"><ion-icon name="ribbon"></ion-icon>&nbsp;about</a>
        </li>
        ...
        <li class="nav-item ">
         ...
         <li class="nav-item ">
          <a class="nav-link  d-flex align-items-center" href="pp.php"><ion-icon name="lock-closed"></ion-icon>&nbsp;Privacy policy</a>
        </li>
         <li class="nav-item ">
